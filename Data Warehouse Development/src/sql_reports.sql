...
-- Report 2
-- City and country sales performance report.
-- For each city and country, display the total number of products sold, total number of product vendors,
-- total number of customers, and total sales amount. Rank cities based on sales in descending order.
SELECT 
    c.city,
    c.country,
...
-- Report 3
-- Monthly report on the most profitable customers.
-- For each customer, display the month and year, customer name, total number of products bought,
-- total number of product vendors/categories, total sales, and total profit or loss.
-- Rank customers based on profit within each month in descending order.
...
-- Report 4
-- Monthly report on the profitability of product vendors/product lines.
-- For each product vendor, display the month and year, total sales count, total actual profit,
-- total possible profit, and the profit gap (difference between possible and actual profit).
-- Rank product vendors based on actual profit within each month in descending order.
